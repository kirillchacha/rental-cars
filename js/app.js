    ...
    (() => {
        ...
        if (document.querySelector("[data-datepicker-1]")) {
            const picker = datepicker_min("[data-datepicker-1]", {
                ...
                customMonths: [ "Jan", "Feb", "März", "April", "Mai", "Jun", "Jul", "Aug", "Sep", "Oktob", "Novemb", "Dezemb" ],
                overlayButton: "Anwenden",
                overlayPlaceholder: "Jahr (4 Ziffern)",
                startDay: 1,
        ...
        if (document.querySelector("[data-datepicker-2]")) {
            const picker = datepicker_min("[data-datepicker-2]", {
                customDays: [ "Mo", "Di", "Mi", "Do", "Fr", "Sa", "So" ],
                customMonths: [ "Jan", "Feb", "März", "April", "Mai", "Jun", "Jul", "Aug", "Sep", "Oktob", "Novemb", "Dezemb" ],
                overlayButton: "Anwenden",
                overlayPlaceholder: "Jahr (4 Ziffern)",
        ...
        function initSliders() {
            if (document.querySelector(".content-specialsandpromotions__slider")) new swiper_core_Swiper(".content-specialsandpromotions__slider", {
                ...
                pagination: {
                    ...
                    clickable: true,
                    type: "fraction",
                    renderFraction: function(specialsCurrentSliderClass, specialsTotalSliderClass) {
                        return '<div class="' + specialsCurrentSliderClass + '"></div>' + "/" + '<div class="' + specialsTotalSliderClass + '"></div>';
                    }
                },
                navigation: {
                    prevEl: ".content-specialsandpromotions__arrow.swiper-button-prev",
                    nextEl: ".content-specialsandpromotions__arrow.swiper-button-next"
                },
                on: {}
            });
            if (document.querySelector(".brand-logo__slider")) new swiper_core_Swiper(".brand-logo__slider", {
